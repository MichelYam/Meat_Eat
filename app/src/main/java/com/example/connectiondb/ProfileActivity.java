...
public class ProfileActivity extends AppCompatActivity {
            ...
            private static String URL_READ="http://192.168.1.43/meeteat_android_php/read_detail.php";
            private static String URL_EDIT="http://192.168.1.43/meeteat_android_php/edit_detail.php";
